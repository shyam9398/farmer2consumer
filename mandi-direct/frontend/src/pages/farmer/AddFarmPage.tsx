...
import { useCreateFarm } from "@/hooks/useFarmer";
...
export const AddFarmPage: React.FC = () => {
  ...
  const onSubmit = async (values: FarmFormValues) => {
    ...
    try {
      ...
      setErrorMessage(
        err?.response?.data?.detail || "Failed to register farm. Please verify all inputs."
      );
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 sm:px-8 py-8 space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-white">Register New Farm Parcel</h1>
          <p className="text-xs text-slate-400">
            Provide details about land ownership, soil, irrigation, and primary crops.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card className="glass-card">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-xs text-slate-400">
              Basic identification and tenure of this specific agricultural plot.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="glass-card">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-xs text-slate-400">
              Soil, irrigation, and primary crops help match you with relevant institutional buyers.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="BLACK">Black Soil (काली मिट्टी / Regur)</option>
              ...
              <div className="space-y-1.5">
                ...
                >
                  ...
                  <option value="DRIP">Drip Irrigation (सूक्ष्म सिंचाई)</option>
            ...
            <div className="space-y-2 pt-2 border-t border-border/40">
              ...
              <div className="flex items-center gap-2 pt-2">
                <Input
                  placeholder="Or enter other crop name..."
        ...
        <Card className="glass-card">
          <CardHeader className="pb-3">
            ...
            <CardDescription className="text-xs text-slate-400">
              Precise location enables accurate transport dispatch and cold chain allocation.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <Link to="/farmer/farms">
            <Button variant="ghost" type="button" disabled={isSubmitting || createFarm.isPending}>
              Cancel
            </Button>
          </Link>
          <Button
            type="submit"
            variant="harvest"
            disabled={isSubmitting || createFarm.isPending}
            className="gap-2 px-6"
          >
            <Save className="h-4 w-4" />
            <span>{isSubmitting || createFarm.isPending ? "Registering Farm..." : "Save Farm Parcel"}</span>
          </Button>
        </div>
      </form>
    </div>
